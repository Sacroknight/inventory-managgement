 ...
 * @author jorgeafv
 */
public class edit_product_panel extends javax.swing.JPanel {
    ...
    private void initStyles() {
        ...
        jLabel8.setFont(FlatUIUtils.nonUIResource(UIManager.getFont("h2.font")));
...
private void editProduct() {
    try {
        ...
        String nombreSeleccionado = (String) product_name.getSelectedItem();
        ...
        String nuevoNombre = price.getText();
        String nuevaCategoria = (String) cat.getSelectedItem();
        String nuevoPrecio = name.getText();
        String nuevaDescripcion = description.getText();
        String nuevaCantidad = stock.getText();

        // Verificar que los campos no estén vacíos
        if (nuevoNombre.isEmpty() || nuevoPrecio.isEmpty() || nuevaCantidad.isEmpty() || nuevaDescripcion.isEmpty() || selectedImage == null) {
            JOptionPane.showMessageDialog(this, "Todos los campos son obligatorios", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Convertir el nuevo precio y cantidad a enteros (puedes agregar manejo de errores aquí)
        float nuevoPrecioFloat = Float.parseFloat(nuevoPrecio);
        int nuevaCantidadInt = Integer.parseInt(nuevaCantidad);

        // Obtener el ID del nuevo nombre de la categoría
        int nuevaIntCategoriaId = getIntCatId(nuevaCategoria);

        // Llamar al método existente en el DAO para editar el producto con la nueva información
        int rowsAffected = intproductoDao.updateProducto(nombreSeleccionado, nuevaIntCategoriaId, nuevoPrecioFloat, nuevoNombre, nuevaCantidadInt, nuevaDescripcion, selectedImage);

        if (rowsAffected > 0) {
            JOptionPane.showMessageDialog(this, "Producto editado exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "No se pudo editar el producto", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void addProduct() {
        try {
            ...
            String nombre = String.valueOf(product_name.getSelectedIndex());
    ...
    private void loadProductsFromDatabase() {
        try {
            ...
            try {
                ...
                product_name.setModel(new DefaultComboBoxModel<>(producList.toArray(new String[0])));
...
private int getIntCatId(String categoria) throws SQLException {
    ...
    private void initComponents() {
        ...
        product_name.setMaximumSize(new java.awt.Dimension(1024, 1024));
        ...
        add_img_button.setText("Editar Producto");
    ...
    private javax.swing.JComboBox product_name;
